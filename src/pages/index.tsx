...
export default function Home() {
	...
	React.useEffect(() => {
		...
		if (canvas) {
			for (let i = 0; i < 3; i++) {
				universe.addBody(new Body(2, "white"), random(canvasSize.width), random(canvasSize.height))
			}
